...
import type { ReceiptDetails } from '../utils/types';
...
const ReceiptGeneratorPage: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-xl p-6 sm:p-8 md:p-12 border border-slate-200 mx-auto my-4 sm:my-8 w-full max-w-[210mm] shadow-xl">
